...
engine = create_engine('postgresql://postgres:postgres:Port/Name')
...
lehrer_liste = [
    ...
    {"Vorname": "Walter",   "Nachname": "Maulhardt",    "Geburtstag": "1950-12-24", "Fach": "Elektrotechnik"},
...
# Teile die Schülerliste in Gruppen von je 5 Schülern auf
